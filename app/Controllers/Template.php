...
class Template extends BaseController
{
    ...
    public function marketplace()
    {
        ...
        $container     = view('product/catalog');
        $container_js  = view('product/catalog_js');
        $container_css = view('product/catalog_css');
        $this->template_marketplace($title, $container, $container_js, $container_css);
    }
    ...
    public function adminLTE()
    {
        ...
        $sidebar       = view('template/admin/sidebar');
        $container     = view('template/login/menu/view');
        $container_js  = view('template/login/menu/js');
        $container_css = view('template/login/menu/css');
        $this->template_admin($title, $sidebar, $container, $container_js, $container_css);
